...
import com.example.news24.databinding.FragmentPoliticsBinding
...
class PoliticsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentPoliticsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = PoliticsFragment()
    }
}